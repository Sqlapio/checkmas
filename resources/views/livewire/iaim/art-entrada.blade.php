...
@endphp
<div class="p-2">
    <h1 class="text-xl mb-4">Movimientos de inventario (entradas)</h1>
    <div class="overflow-auto rounded-lg shadow md:block">
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-4 mt-8">
            <div class="p-2">
        ...
        <table class="w-full mt-12">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                ...
                <tr>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap max-[320px]:hidden max-[420px]:hidden xs:hidden sm:hidden md:hidden lg:table-cell">{{ $item->fecha_entrada }}</td>
