...
<div class="p-5">
    ...
    <div class="overflow-auto rounded-lg shadow md:block">
        ...
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4 mb-4 mt-8">
            ...
            <div class="p-2">
                ...
                <x-input icon="pencil" wire:model="proveedor"  class="focus:ring-check-blue focus:border-check-blue"/>
            </div>
            <div class="p-2">
        ...
        <table class="w-full mt-12">
            ...
            <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                ...
                <tr>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ $item->proveedor }}</td>
                    ...
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{{ app('App\Http\Controllers\UtilsController')->total_existe($item->codigo) }}</td>
                    <td class="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                        {{ QrCode::size(50)->generate('#'.$item->codigo) }}
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    // validar solo numeros punto y coma?
